package com.rokid.falconcloudclient.bean.response.responseinfo;

import android.text.TextUtils;

import com.rokid.falconcloudclient.bean.response.responseinfo.action.ActionBean;
import com.rokid.falconcloudclient.bean.response.responseinfo.card.CardBean;

/**
 * There are two sections in response .
 * card is the response for mobile card display. And action is for falconcloudclient.
 * <p>
 * Author: xupan.shi
