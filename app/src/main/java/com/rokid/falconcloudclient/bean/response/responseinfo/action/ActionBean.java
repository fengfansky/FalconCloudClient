package com.rokid.falconcloudclient.bean.response.responseinfo.action;

import android.text.TextUtils;

import com.rokid.falconcloudclient.bean.response.responseinfo.action.confirm.ConfirmBean;
import com.rokid.falconcloudclient.bean.response.responseinfo.action.display.DisplayBean;
...
public class ActionBean {
    ...
    private String type;
    /**
     * 表明当此次返回的action执行完后 falconcloudclient 是否要退出，同时，当 shouldEndSession 为 true     * 时，falconcloudclient 将会忽略 EventRequests，即在action执行过程中不会产生 EventRequest。
     */
